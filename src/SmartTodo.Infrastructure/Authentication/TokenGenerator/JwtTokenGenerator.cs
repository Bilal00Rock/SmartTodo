...
using SmartTodo.Infrastructure.Authentication.Claims;

namespace SmartTodo.Infrastructure.Authentication.TokenGenerator;
...
public class JwtTokenGenerator(IOptions<JwtSettings> jwtOptions) : IJwtTokenGenerator
{
    ...
    private static void AddIds(User user, List<Claim> claims)
    {
        claims
            ...
            .AddIfValueNotNull("normalUserId", user.NormalUserId?.ToString());
    }
